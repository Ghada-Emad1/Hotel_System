        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6" enctype="multipart/form-data">
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    <select id="country" name="country" class="form-control p-2 rounded-md" v-model="form.country" required>
                ...
                <div class="grid gap-2">
                    ...
                    <select id="gender" name="gender" class="form-control p-2 rounded-md" v-model="form.gender" required>
